...
function createLanternModel() {
    ...
    const body = new THREE.Mesh(
        ...
        new THREE.MeshStandardMaterial({ color: '#cc8800', emissive: '#ffaa00', emissiveIntensity: 1.2, roughness: 0.3 })
    );
    body.position.y = 0.1;
    group.add(body);
    // top
    ...
    lanternLight = new THREE.PointLight('#FFAA00', 3.5, 6);
...
export function updateLanternPosition() {
    ...
    const offset = new THREE.Vector3(-0.3, 0.9, 0.3);
    ...
    if (characterFillLight) {
        ...
        facePos.y += 0.75;   // roughly face/head height
